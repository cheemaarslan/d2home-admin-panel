...
<Col span={24} className='col' style={{ display: 'flex', justifyContent: 'flex-end' }}>
  {/* Only show Apply Discount button by default */}
  {!showDiscountInput ? (
    <Button
      type="primary"
      onClick={() => setShowDiscountInput(true)}  // Show input only when clicked
    ...
    /* Only show input field AFTER button click */
    <div style={{ display: 'flex', gap: '10px' }}>
      ...
      <Button
        type="primary"
        onClick={() => {
          // Your apply discount logic here
